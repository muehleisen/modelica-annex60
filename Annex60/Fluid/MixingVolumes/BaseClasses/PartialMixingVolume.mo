...
When using steady state energy dynamics and <code>prescribedHeatFlowRate=true</code> 
an assert is added that checks if the prescribed
heat flow rate is zero when the mass flow rate equals zero, 
